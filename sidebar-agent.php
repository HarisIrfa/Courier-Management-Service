...
<!-- Sidebar HTML -->
 <div class="sidebar d-flex flex-column position-fixed h-100" id="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a class="nav-link" href="stats-agent.php">
                <i class="bi bi-graph-up me-2"></i>
                <span>Stats</span>
            </a>
            <a class="nav-link" href="track-parcel-agent.php">
            ...
            <div class="submenu collapse" id="deliveriesMenu">
                <a class="nav-link" href="show-delivery-agent.php"><i class="bi bi-truck nav-icon me-2"></i>Show Parcel</a>
            </div>
